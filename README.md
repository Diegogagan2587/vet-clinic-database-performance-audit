...
> **[Vet clinic database]** This is a project where I create a database called vets with several tables, I insert data into the tables and make pracitce with them, inserting data, reomving data, connecting data, etc...
...
Feel free to check the [issues page](https://github.com/Diegogagan2587/vet-clinic-database-performance-audit/issues).
